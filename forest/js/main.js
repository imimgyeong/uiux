...
$(document).ready(function(){
    const myFullpage = new fullpage('#fullpage', {  /* html에서 페이지 전체를 감싸는 요소 */
		...
		navigationTooltips: ['메인', '나무심기', '숲활동', '활동이야기', 'footer'], /* 툴팁 */
		...
		afterLoad: function(origin, destination, direction, trigger){
			// console.log('나오니', destination)
			if((destination.index == 1) || (destination.index == 2) || (destination.index == 3)){ /* index가 2면 슬라이드는 세번째 슬라이드입니다. index 수는 0/1/2/3 */
	 ...
	 * ------>quick_wrap slideDown()으로 나타남
	 * aside.quick.close 를 클릭하면 aside.quick에 open 삭제 
	 * ------>
	 *******************************************/
