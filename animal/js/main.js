...
$(document).ready(function(){
    ...
    function updateCurrent() {
        ...
        //슬라이드가 교체되면 제일 먼저 넓이를 0으로 초기화 해줘야함
        $('.visual .ctrl_btn .paging .bar span').stop()//animate 종료
    ...
    */
    ...
    /*----------- 시작 : 찾습니다 tab  -----------
    *.find .tab_list ul li를 클릭했을때 1번째를 클릭하면 active클래스를 주고
    * li에서 어떤 tab_item을 보이게 해야하는지 단서를 줘야함
    *.find .tab_content .tap_item에서 1번째 요소에 active클래스를 줌 
    */
    ...
    $('.find .tab_list ul li').on('click', function(){
        ...
        //클릭한 li와 관련된 tab_content tab_item에 active클래스 주기
